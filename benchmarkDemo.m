...
ellImagePath = fullfile(tempPath,'ellImage.png');
...
[drop drop mserSubsRes] = ...
    repBenchmark.testFeatureExtractor(mserDetector, ...
                              dataset.getSceneGeometry(imageBIdx), ...
                              dataset.getImagePath(1), ...
                              dataset.getImagePath(imageBIdx)) ;
...
benchmarks.helpers.plotFrameMatches(mserSubsRes, ...
                                    'IsReferenceImage',false);
...
matchBenchmark = RepeatabilityBenchmark(HomographyConsistencyModel(), ...
  'Mode','MatchingScore');
...
subplot(1,2,2); imshow(image);
benchmarks.helpers.plotFrameMatches(mvmSubsRes,...
  'IsReferenceImage',false);
