  ...
  methods
    ...
    function [corresps consistency subsres] = findConsistentCorresps(obj, ...
      ...
      if obj.Opts.cropFrames
        ...
        if ~isempty(obj.Opts.cropFramesSafetyEdge)
          seRatio = obj.Opts.cropFramesSafetyEdge;
          bboxA = bboxA + [imageASize(1:2).*seRatio, -imageASize(1:2).*seRatio];
          bboxB = bboxB + [imageBSize(1:2).*seRatio, -imageBSize(1:2).*seRatio];
        end
